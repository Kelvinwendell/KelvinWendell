...
Possuo conhecimentos em **Java** e **Python** entre outras linguagens, além de experiência com lógica de programação, estruturas de dados e banco de dados. Também tenho familiaridade com o desenvolvimento e consumo de **APIs REST**, além de conhecimentos em **Inteligência Artificial** e ferramentas de análise de dados, contribuindo para soluções orientadas a dados.
